...
$_['text_additional_image']  = '%s — дополнительное фото';
...
$_['text_filter_any']        = 'Любое';
$_['text_filter_in_stock']   = 'В наличии';
$_['text_filter_out_of_stock'] = 'Под заказ или нет в наличии';
$_['text_filter_collections'] = 'Подборки';
$_['text_filter_new']        = 'Новинки';
$_['text_filter_sale']       = 'Скидки';
$_['text_catalog_search']     = 'Поиск по каталогу';
$_['text_catalog_search_label'] = 'Поиск по товарам';
$_['text_catalog_search_placeholder'] = 'Например: серьги, браслет, подвеска';
$_['text_all_categories']     = 'Все категории';
$_['text_search_subcategories'] = 'Искать в подкатегориях';
$_['text_search_description'] = 'Искать в описании';
$_['text_catalog_search_empty'] = 'По вашему запросу ничего не найдено. Попробуйте изменить запрос или открыть весь каталог.';
...
$_['button_filter_apply']   = 'Применить';
$_['button_filter_reset']   = 'Сбросить';
$_['button_open_catalog']    = 'Открыть каталог';
