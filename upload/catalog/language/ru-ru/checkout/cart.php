...
$_['text_next']                    = 'Что вы хотели бы сделать ещё?';
...
$_['text_cart_empty_help']          = 'Добавьте украшение из каталога, чтобы продолжить оформление заказа.';
$_['text_cart_action']               = 'Перейти в корзину';
$_['text_continue_action']           = 'Продолжить покупки';
$_['text_cart_intro']                = 'Проверьте состав заказа, количество товаров и итоговую стоимость перед оформлением.';
$_['text_product_details']           = 'Выбранные параметры товара';
$_['text_summary']                   = 'Итого по заказу';
$_['text_cart_help']                 = 'Стоимость доставки будет рассчитана после заполнения адреса на следующем шаге.';
$_['text_day']                     = 'день';
$_['text_week']                    = 'неделя';
