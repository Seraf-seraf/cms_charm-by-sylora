...
(function(window, document) {
	...
	function writeChoice(choice) {
		...
		document.cookie = cookieName + '=' + encodeURIComponent(choice) + '; Max-Age=31536000; Path=/; SameSite=Lax' + secure;
	}
	...
	window.SyloraCookieConsent = {
		...
		isAnalyticsAllowed: function() {
			return getChoice() === analyticsChoice;
		},
		open: function() {
			setBannerVisible(true, true);
		}
