...
class ControllerStartupStartup extends Controller {
	...
	private function getContentSecurityPolicy($nonce) {
		$directives = array(
			...
			"form-action 'self'",
			"script-src 'self' 'nonce-" . $nonce . "' https://mc.yandex.ru https://yastatic.net https://cdn.jsdelivr.net/npm/@cdek-it/widget@3.10.4/dist/cdek-widget.umd.js https://api-maps.yandex.ru https://*.api-maps.yandex.ru https://suggest-maps.yandex.ru https://yandex.ru",
			...
			"frame-src https://api-maps.yandex.ru blob: https://mc.yandex.ru",
