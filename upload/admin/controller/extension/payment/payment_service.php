...
class ControllerExtensionPaymentPaymentService extends Controller {
	...
	public function uninstall() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "payment_service_event`");
	}
	...
	protected function validate() {
		...
		if (empty($this->request->post['payment_payment_service_api_url']) || !filter_var($this->request->post['payment_payment_service_api_url'], FILTER_VALIDATE_URL)) {
			$this->error['api_url'] = $this->language->get('error_api_url');
		}

		if (empty($this->request->post['payment_payment_service_api_key'])) {
			$this->error['api_key'] = $this->language->get('error_api_key');
		}

		if (empty($this->request->post['payment_payment_service_shared_secret'])) {
