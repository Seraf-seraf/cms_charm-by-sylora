...
$_['error_pending_status_blocked']  = 'Select a pending status outside the processing and complete status lists.';
$_['error_success_status_blocked']  = 'Select a succeeded status from the processing or complete status list.';
$_['error_failed_status_blocked']   = 'Select a failed status outside the processing and complete status lists.';
$_['error_canceled_status_blocked'] = 'Select a canceled status outside the processing and complete status lists.';
$_['error_refunded_status_blocked'] = 'Select a refunded status outside the processing and complete status lists.';
