...
$_['text_secret_saved']            = 'Значение сохранено в настройках магазина. Оставьте поле пустым, чтобы не менять.';
...
$_['help_shared_secret']           = 'Не менее 32 символов. Значение сохраняется в настройках OpenCart; оставьте поле пустым, чтобы не менять.';
...
$_['error_api_key']               = 'Укажите фактический API key мерчанта.';
$_['error_shared_secret']         = 'Укажите фактический shared secret длиной не менее 32 символов.';
$_['error_pending_status_blocked']  = 'Выберите статус ожидания вне списков "В обработке" и "Завершено".';
$_['error_success_status_blocked']  = 'Выберите статус успешной оплаты из списка "В обработке" или "Завершено".';
$_['error_failed_status_blocked']   = 'Выберите статус ошибки оплаты вне списков "В обработке" и "Завершено".';
$_['error_canceled_status_blocked'] = 'Выберите статус отмены оплаты вне списков "В обработке" и "Завершено".';
$_['error_refunded_status_blocked'] = 'Выберите статус возврата вне списков "В обработке" и "Завершено".';
