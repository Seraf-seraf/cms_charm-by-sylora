...
final class HomeUiContractTest extends TestCase {
	...
	public function testHeroUsesAdminManagedAutomaticSlideshow(): void {
		...
		self::assertStringContainsString('autoplay: 5000', $slideshow);
		self::assertStringContainsString('autoplayDisableOnInteraction: false', $slideshow);
		self::assertStringContainsString('loop: true', $slideshow);
