...
final class CookieConsentBrowserResult {
	public function __construct(
		...
		public readonly bool $settingsInSiteFooter,
		public readonly bool $settingsInCatalogCard,
	...
	public static function fromArray(array $result): self {
		return new self(
			...
			self::readBool($result, 'settingsInSiteFooter'),
			self::readBool($result, 'settingsInCatalogCard'),
